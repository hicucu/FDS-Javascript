...
(function () {
  var SERVER = '';
  var TODOS = "".concat(SERVER, "/todos");

  var TODO = function TODO(id) {
    return "".concat(SERVER, "/todos/").concat(id);
  };

  var COMPLETE = "".concat(SERVER, "/todos/completed");
    ...
    _createClass(App, [{
      ...
      value: function init() {
        ...
        this.$todos.addEventListener('click', function (e) {
          return _this.removeTodo(e.target);
        });
        ...
        this.$nav.onclick = function (e) {
          ...
          _this.setNavTarget(e.target);
        };

        this.$inputTodo.onkeyup = function (e) {
          if (_this.$inputTodo.value.trim() === '' || e.keyCode !== 13) return;
      ...
      value: function addTodo() {
        ...
        var content = this.$inputTodo.value;
        var completed = false;
        this.getTodos('POST', TODOS, {
          id: id,
          content: content,
          completed: completed
        });
      ...
      key: "setNavTarget",
      value: function setNavTarget(target) {
        _toConsumableArray(this.$nav.children).forEach(function (c) {
      ...
      key: "setClearCompletedDiv",
      value: function setClearCompletedDiv() {
        var completedTodos = document.querySelector('.completed-todos');
        var activeTodos = document.querySelector('.active-todos');

        var _this$todos$filter = this.todos.filter(function (todo) {
          return todo.completed;
        }),
            length = _this$todos$filter.length;
      ...
      key: "setCheckboxAll",
      value: function setCheckboxAll() {
        var notCompletedCount = this.todos.filter(function (todo) {
          return !todo.completed;
        }).length;
        this.$ckCompleteAll.checked = notCompletedCount !== this.todos.length && !(notCompletedCount > 0);
      }
    }, {
      key: "getActiveNavList",
      value: function getActiveNavList() {
        var activeList = [];
        ...
        switch (this.navTarget) {
          ...
          case 'active':
            Object.assign(activeList, this.todos.filter(function (todo) {
              return !todo.completed;
            }));
            break;
      ...
      key: "changeTodosList",
      value: function changeTodosList(displayList) {
        var _this2 = this;

        _toConsumableArray(this.$todos.children).forEach(function (c) {
          return c.remove();
        });

        var todos = displayList.map(function (todo) {
          ...
          label.setAttribute('for', "ck-".concat(li.id));
        ...
        todos.forEach(function (li) {
          return _this2.$todos.append(li);
        });
      }
    }, {
      key: "render",
      value: function render() {
        var displayList = this.getActiveNavList();
      ...
      key: "removeTodo",
      value: function removeTodo(target) {
      ...
      value: function generateId() {
        return this.todos.length ? Math.max.apply(Math, _toConsumableArray(this.todos.map(function (todo) {
          return todo.id;
        }))) + 1 : 1;
      }
    }, {
